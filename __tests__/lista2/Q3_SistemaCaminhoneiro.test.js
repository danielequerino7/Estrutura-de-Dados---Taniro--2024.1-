...
import agendamentoCaminhoneiros from "../../src/lista2/Q3_SistemaCaminhoneiro";
...
test("Testando o carregamento atingido",
    () => {
        ...
        expect(() => c.chegadaCaminhoneiro("Josafá")).toThrow("Número de carregamento atingido");
    }
);
...
test("Testando a listagem em aguardo",
    () => {
        ...
        c.chegadaCaminhoneiro("Manuel");
        c.chegadaCaminhoneiro("Bento");
        expect(c.listarCaminhoneiros()).toBe("1-Roberto 2-Francisco 3-Manuel 4-Bento");
    }
);
